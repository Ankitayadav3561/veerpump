...
$mail->AddAddress("designerankita5@gmail.com");
...
$mail->Body = '
	...
	<tbody>
		<table width="100%" style="border:1px solid;" cellpadding="35" cellspacing="1">
			<tr>
				<td style="background:#0183cf; text-align: center; font-size: 25px; color:#fff;">Chaitanya Global Exim</td>
			</tr>			
		</table>
		<table width="100%" cellpadding="1" cellspacing="10">
			<tr>
				<td>You Have received a enquiry form <b>Adjoint Infocom Private Limited</b></td>
			</tr>
			<tr>
